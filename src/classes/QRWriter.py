...
class QRWriter ():
    ...
    def generate(self,_source_image,_code,_output_folder)->bool:
        ...
        final_path = self._copy_image_to_output(new_image,_output_folder)
    ...
    def _calculate_qr_scale(self,_source_image):
        ...
        scale = source.width*0.0025
        return scale
        ...

    def _add_qrcode_to_image(self,_source_image:str,_code:str)->str:
    ...
    def _generate_image_with_qr_code(self,_code,_scale:float=8):
    ...
    def _paste_image_in_corners(self,_image_under,_image_over):
        copy = self._copy_image_to_temp(_image_under)
